object FormVendaItem: TFormVendaItem
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object LblProdutoCodigoBarra: TLabel
    Left = 16
    Top = 16
    Width = 93
    Height = 18
  ...
  object EdtProdutoCodigoBarra: TEdit
    Left = 16
    Top = 40
    Width = 265
    Height = 29
    ...
    ParentFont = False
    TabOrder = 1
    OnExit = EdtProdutoCodigoBarraExit
  end
  ...
  object EdtProdutoPrecoVenda: TEdit
    Left = 16
    Top = 184
    Width = 265
    Height = 29
